...
// Diff/Merge 行级比较流程参考 IntelliJ IDEA Community Edition / IntelliJ Platform 的 Apache-2.0 源码语义，并按本项目 Electron/TypeScript 架构重写。
 ...
 */
function buildConflictMergeLineMergeRanges(args: {
  baseLength: number;
  oursLength: number;
  theirsLength: number;
...
export function buildConflictMergeLineRanges(args: {
  ...
  return buildConflictMergeLineMergeRanges({
